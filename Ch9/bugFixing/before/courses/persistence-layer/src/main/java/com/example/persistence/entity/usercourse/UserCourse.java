...
public class UserCourse extends IdEntity {
    ...
    public Long getCourseId() {
        return Optional.ofNullable(courseId).orElseGet(() -> Optional.ofNullable(course).map(Course::getId).orElse(null));
    }

    public Long getUserId() {
        return Optional.ofNullable(userId).orElseGet(() -> Optional.ofNullable(user).map(User::getId).orElse(null));
    }
