...
public class CourseV1Dto implements Dto {
    ...
    private final List<CourseModuleV1Dto> modules;
    ...
    public List<CourseModuleV1Dto> getModules() {
        return modules;
    }
    ...
    public static class Builder implements FluentBuilder<CourseV1Dto> {
        ...
        private List<CourseModuleV1Dto> modules;

        public Builder withModules(List<CourseModuleV1Dto> modules) {
